...
namespace BihuApiCore.Repository.UnitTest
{
    public class TestContext : DbContext
    {
        ...
        public TestContext(DbContextOptions<EntityFrameworkCore.Models.bihu_apicoreContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySql("Server=localhost;User Id=root;Password=123456;Database=bihu_apicore_test;sslmode=none;");
            }
        }
